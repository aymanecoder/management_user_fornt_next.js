...
export default function User({user ,deleteUser, editUser}) {
  return (
                    ...
                    <tr key={user.id}>
                        ...
                        <td className="text-left px-6 py-4 whitespace-nowrap">
                           <a onClick={(e, id) => editUser(e, user.id)} className="text-indigo-600 hover:text-indigo-800 hover:cursor-pointer px-4">Edit</a>
